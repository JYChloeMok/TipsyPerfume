...
public class ProductCategoryDao {
	...
	public int drinkFundingInsert(SqlSessionTemplate sqlSession, ProductCategoryVO pc) {
	...
	public int updateDrinkFunding(SqlSessionTemplate sqlSession, ProductCategoryVO pc) {
